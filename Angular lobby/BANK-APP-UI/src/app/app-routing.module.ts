...
/**
 * For some few path below you can see something like: canActivate key
 * Its for protecting my paths so that my enduser can not access them without login in. As a value; I have defined some logic inside AuthActivateRouteGuard. Ctrl + click to see!
 */
const routes: Routes = [
